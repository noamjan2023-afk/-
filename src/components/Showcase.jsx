...
export default function Showcase() {
  ...
  return (
    <section className="w-full h-screen bg-obsidian z-10 relative flex items-center overflow-hidden border-t border-white/5 pause-marquee" data-magnetic="true">
